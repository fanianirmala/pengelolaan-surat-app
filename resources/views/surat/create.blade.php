...
@section('content')
    ...
    <div class="container">
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('letter_perihal') is-invalid @enderror" id="letter_perihal" name="letter_perihal">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select class="form-select @error('role') is-invalid @enderror" id="letter_type_id" name="letter_type_id">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <select class="form-select @error('notulis') is-invalid @enderror" id="notulis" name="notulis">
                <option value="" hidden>Choose..</option>
                {{-- data relasi --}}
